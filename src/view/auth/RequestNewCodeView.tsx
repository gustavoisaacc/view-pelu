...
import { RequestConfirmationCodeForm } from "../../schema/auth";
    ...
    <div className="w-[90%] m-auto">
      ...
      >
        ...
        <input
          type="submit"
          value="Enviar Código"
          className=" bg-lightpurple hover:bg-fuchsia-700 w-full p-3 rounded-lg text-white font-black  text-xl cursor-pointer"
        />
      </form>
